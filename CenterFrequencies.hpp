...
{
  typedef std::tuple < TMP_Fraction<15, 84893, 100000>, TMP_Fraction<17, 78279, 100000>,
    ...
    TMP_Fraction<15848, 93192, 100000 >, TMP_Fraction<17782, 7941, 100000>, TMP_Fraction < 19952, 62315, 100000 >> result;
